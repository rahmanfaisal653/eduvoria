    ...
    <header class="w-full border-b border-gray-100 bg-white shadow-sm">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <nav class="hidden md:flex space-x-6 text-sm">
                <!-- Gunakan route() di Laravel nyata -->
                <a href="homepage.html" class="font-semibold text-teal-600 border-b-2 border-teal-600 pb-1">Beranda</a>
                <a href="komunitas" class="text-gray-500 hover:text-teal-600 hover:border-b-2 hover:border-teal-600 hover:pb-1 hover:font-semibold">Komunitas</a>
            </nav>
            ...
            <div class="flex items-center space-x-4">
                ...
                <button id="subscribe-button" class="bg-cyan-500 text-white py-1.5 px-3 rounded-full text-sm font-semibold hover:bg-cyan-600 transition shadow-md">
                    Subscribe
                </button>
                ...
                <div class="relative">
                    ...
                    >
                        <div class="py-1" role="none">
                            <a href="profile.html" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700 font-semibold" role="menuitem" tabindex="-1">
                                👤 Profile
                            </a>
                            <div class="border-t border-gray-100 my-1" role="separator"></div>
                            <a href="bookmark.html" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700" role="menuitem" tabindex="-1">
                                🔖 Bookmark
                            </a>
                            <a href="statistic.html" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700" role="menuitem" tabindex="-1">
                                📈 Statistik
                            </a>
                            <a href="settings.html" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700" role="menuitem" tabindex="-1">
                                ⚙️ Settings
                            </a>
                            <div class="border-t border-gray-100 my-1" role="separator"></div>
                            <a href="/Login & Regist/login.html" class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-50 hover:text-red-700" role="menuitem" tabindex="-1">
                                🚪 Logout
                            </a>
                        </div>
                    </div>
