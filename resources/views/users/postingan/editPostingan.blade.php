...
<div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow-lg mt-6">
    ...
    <form action="{{ url('/posts/'.$post['id'].'/update') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="isi" rows="5" class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-teal-500">{{ $post['isi'] }}</textarea>
        </div>

        <div class="flex justify-between items-center mt-6">
            <a href="/profile" class="text-gray-500 hover:underline">← Kembali</a>
